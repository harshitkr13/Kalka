  ...
  try {
    ...
    if (!res.ok) {
      ...
      if (res.status === 503) {
        return {
          success: false,
          error: 'Inquiry service is temporarily degraded. Please email kalkacomediaconsultancy@gmail.com or call our direct switchboard.',
    ...
    return {
      success: false,
      error: 'Network connection failed while transmitting inquiry. Please check your connection or email kalkacomediaconsultancy@gmail.com directly.',
